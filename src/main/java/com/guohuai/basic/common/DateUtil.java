...
public class DateUtil {
	...
	public static boolean eq(Date param0, Date param1) {
	...
	public static int compare(Date param0, Date param1) {
		Calendar c0 = Calendar.getInstance();
		c0.setTimeInMillis(param0.getTime());
		long l0 = c0.get(Calendar.YEAR) * 10000 + c0.get(Calendar.MONTH) * 100 + c0.get(Calendar.DATE);
	...
	public static Date beginTimeInMillis() {
		return beginTimeInMillis(new Date());
	}

	public static Date endTimeInMillis() {
		return endTimeInMillis(new Date());
	}

	public static Date beginTimeInMillis(Date date) {
	...
	public static Date endTimeInMillis(Date date) {
		Calendar c = Calendar.getInstance();
		c.setTime(date);
