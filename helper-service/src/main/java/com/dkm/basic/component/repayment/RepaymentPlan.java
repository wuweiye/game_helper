package com.dkm.basic.component.repayment;

import com.dkm.basic.common.DateUtil;
import com.dkm.basic.component.repayment.mode.MonthDaysMode;
import com.dkm.basic.component.repayment.rate.YieldRate;
import lombok.Data;
...
public class RepaymentPlan {
	 ...
	 * @return 还款计划列表
	 */
	public static List<Plan> aDebtServiceDue(Date startDate, Date endDate, BigDecimal principal, YieldRate rate) {
	 ...
	 * @return 还款计划列表
	 */
	public static List<Plan> eachInterestRincipalDue(Date startDate, Date endDate, BigDecimal principal, YieldRate rate, int repaymentDate, MonthDaysMode mdmode) {
	 ...
	 * @return 还款计划列表
	 */
	public static List<Plan> fixedPaymentMortgage(Date startDate, Date endDate, BigDecimal principal, YieldRate rate, int repaymentDate, MonthDaysMode mdmode) {
	...
	*/
	 ...
	 * @return 还款计划列表
	 */
	public static List<Plan> fixedBasisMortgage(Date startDate, Date endDate, BigDecimal principal, YieldRate rate, int repaymentDate, MonthDaysMode mdmode) {
	...
	*/
	 ...
	 * @return
	 */
	public static List<Plan> firstInterestFixedBasis(Date startDate, Date endDate, BigDecimal principal, YieldRate rate, int repaymentDate, MonthDaysMode mdmode) {
	...
	public static class Plan {
		...
		public void appendTo(List<Plan> list) {
			list.add(this);
		}
	}
}
