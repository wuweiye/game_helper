...
public class ImageUploadUtil {
            ...
            while (iter.hasNext()) {
                ...
                if (file != null) {
                    ...
                    if (myFileName.trim() != "") {
                        ...
                        fileName = Constants.hourAndMinuteFormat.format(new Date()) + suffix;
     ...
     * @throws IOException
     */
    public static void ckeditor(HttpServletRequest request, HttpServletResponse response, String path)
            throws IOException {
