package com.dkm.admin.tulip.schedule;
...
/*
	...
	public void autoLog(){
	    ...
	    log.info("-------------------定时任务start---------------" + Constants.wholeDateFormat.format(new Date()));
        log.info("-------------------定时任务end----------------" + Constants.wholeDateFormat.format(new Date()));
